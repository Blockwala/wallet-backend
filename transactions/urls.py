...
urlpatterns = [
    re_path(r'^generateRawTransaction/$', transactions.generate_raw_transaction, name='generate_raw_transaction'),
    re_path(r'^broadcastTransaction/$', transactions.broadcast_transaction, name='broadcast_transaction')
]