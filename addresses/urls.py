...
urlpatterns = [
    re_path(r'^getAddressBalance/$', address.get_address_balance, name='get_address_balance'),
    re_path(r'^generateAddress', address.generate_address, name = 'generateAddress')
]